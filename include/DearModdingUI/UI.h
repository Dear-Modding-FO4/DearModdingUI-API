...
#undef DMUI_UI_SCALAR
	...
	inline void PushStyleVar(DMUI_UIVar a_var, float a_val) noexcept
	{
		detail::Record(checked::PushStyleVar(a_var, a_val));
	}

	inline void PushStyleVar(DMUI_UIVar a_var, DMUI_Vec2& a_val) noexcept
	{
		detail::Record(checked::PushStyleVar(a_var, &a_val));
	}
